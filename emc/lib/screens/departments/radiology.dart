...
class RadiologyDashboard extends StatelessWidget {
  ...
  void _showPatientRecordSheet(BuildContext context) {
    ...
    final List<String> services = [
      ...
      'X-ray, Hip, Two or Three Views',
      'X-ray, Mandible, Complete, Minimum of Two Views',
      'Ultrasound, Abdomen',
      'Ultrasound, Pelvis',
      'Ultrasound, Transvaginal',
      'Ultrasound, Obstetrics, First Trimester',
      'Ultrasound, Obstetrics, Second Trimester',
      'UUltrasound, Obstetrics, Third Trimester',
